...
barcode=./barcodes/barcodes_L2211-02.txt
#
#
process_radtags -f /scratch/lcartmell/cvicarius_stacks/stacks/L2211-02_S2_L001_R1_001.fastq.gz -o ./L2211-02_re/ -b $barcode --renz-1 pstI --renz-2 mspI --inline-null -c -q -r --filter-illumina --score-limit 30
